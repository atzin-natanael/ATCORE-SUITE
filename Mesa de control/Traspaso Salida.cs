...
{
    public partial class Traspaso_Salida : Form
    {
        List<List<string>> ArticulosTraspasoE = new List<List<string>>();

        public Traspaso_Salida()
        {
            InitializeComponent();
        }
        ...
        public void Guardar(List<List<string>> ArticulosCompra)
        {
            ...
            GetFireBirdValue.InsertCloudValueDocto_in(id_new_int, TxtFolio.Text, 'N', DateTime.Now, fecha, 'T');
